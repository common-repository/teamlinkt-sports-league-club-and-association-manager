...
wp.blocks.registerBlockType('teamlinkt/locations-box', {
	title: 'TeamLinkt Locations',
	icon: 'location-alt',
	category: 'common',
	attributes: {
	},
	...
	edit: function(props) {
		...
		return React.createElement(
			...
			React.createElement(
				"p",
				null,
				"Nicely done. Your locations will appear here."
			)
		);
	},
	save: function(props) {
		...
		return wp.element.createElement(
			...
			{ style: { border: "3px solid " + props.attributes.color } },
				...
				wp.element.createElement("div",{style:{"overflow-x":"scroll"}}, 
					wp.element.createElement("table",{id:"teamlinktLocationsTable", class:"table-borderless"}, null)
				)
		);
	}
})